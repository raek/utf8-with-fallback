...
public class Utf8WithIso88591FallbackCharsetDecoderTest {
	...
	@Test
	public void testDecodingUtf8() throws UnsupportedEncodingException,
			CharacterCodingException {
	...
	@Test
	public void testDecodingIso88591() throws UnsupportedEncodingException,
			CharacterCodingException {
		ByteBuffer buffer = ByteBuffer.wrap("köttfärssås"
				.getBytes("ISO-8859-1"));
		assertEquals("köttfärssås", decoder.decode(buffer).toString());
	}

	@Test
	public void testDecodingTwoByteChars() throws UnsupportedEncodingException,
			CharacterCodingException {
	...
	@Test
	public void testDecodingThreeByteChars()
	...
	@Test
	public void testDecodingFourByteChars()
			throws UnsupportedEncodingException, CharacterCodingException {
	...
	@Test
	public void testDecodingUtf8FollowedByIso88591()
			throws CharacterCodingException {
		// utf-8("åäö") + iso-8859-1("åäö")
		byte[] bytes = { (byte) 0xC3, (byte) 0xA5, (byte) 0xC3, (byte) 0xA4,
				(byte) 0xC3, (byte) 0xB6, (byte) 0xE5, (byte) 0xE4, (byte) 0xF6 };
		ByteBuffer buffer = ByteBuffer.wrap(bytes);
		assertEquals("åäöåäö", decoder.decode(buffer).toString());
	}

	@Test
	public void testDecodingIso88591FollowedByUtf8()
			throws CharacterCodingException {
		// iso-8859-1("åäö") + utf-8("åäö")
		byte[] bytes = { (byte) 0xE5, (byte) 0xE4, (byte) 0xF6, (byte) 0xC3,
				(byte) 0xA5, (byte) 0xC3, (byte) 0xA4, (byte) 0xC3, (byte) 0xB6 };
		ByteBuffer buffer = ByteBuffer.wrap(bytes);
		assertEquals("åäöåäö", decoder.decode(buffer).toString());
	}

	@Test
	public void testDecodingIllegalUtf8Bytes()
			throws UnsupportedEncodingException, CharacterCodingException {
		String s = "üýþÿ";
	...
	@Test
	public void testDecodingSolitaryUtf8ContinuationByte()
			throws UnsupportedEncodingException, CharacterCodingException {
		String s = "\u0094";
		ByteBuffer buffer = ByteBuffer.wrap(s.getBytes("ISO-8859-1"));
		assertEquals(s, decoder.decode(buffer).toString());
	...
	@Test
	public void testDecodingTwoByteEncodedAscii()
			throws UnsupportedEncodingException, CharacterCodingException {
		String s = "\u00C1\u0081";
		ByteBuffer buffer = ByteBuffer.wrap(s.getBytes("ISO-8859-1"));
		assertEquals(s, decoder.decode(buffer).toString());
	...
	@Test
	public void testDecodingThreeByteEncodedAscii()
			throws UnsupportedEncodingException, CharacterCodingException {
		String s = "\u00E0\u0081\u0081";
		ByteBuffer buffer = ByteBuffer.wrap(s.getBytes("ISO-8859-1"));
		assertEquals(s, decoder.decode(buffer).toString());
	...
	@Test
	public void testDecodingFourByteEncodedAscii()
			throws UnsupportedEncodingException, CharacterCodingException {
		String s = "\u00F0\u0080\u0081\u0081";
		ByteBuffer buffer = ByteBuffer.wrap(s.getBytes("ISO-8859-1"));
		assertEquals(s, decoder.decode(buffer).toString());
	...
	@Test
	public void testDecodingOutOfRangeUnicodeCodePoint()
			throws UnsupportedEncodingException, CharacterCodingException {
		byte[] bytes = { (byte) 0xF5, (byte) 0x80, (byte) 0x80, (byte) 0x80 };
		String s = "\u00F5\u0080\u0080\u0080";
		ByteBuffer buffer = ByteBuffer.wrap(s.getBytes("ISO-8859-1"));
		assertEquals(s, decoder.decode(buffer).toString());
	}
	...
	@Test
	public void testDecodingIncompleteUtf8Sequence()
			throws UnsupportedEncodingException, CharacterCodingException {
		byte[] bytes = { (byte) 0xF0, (byte) 0x90, (byte) 0x8C };
		ByteBuffer buffer = ByteBuffer.wrap(bytes);
	...
	public void testFlushBufferOverflow() {
		...
		// When flushing, provide a one char buffer, so that overflow will
		// occur.
