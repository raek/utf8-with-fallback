...
/**
 * A charset that tries to decode in UTF-8 and falls back to ISO 8859-1 for invalid UTF-8 byte sequences.
 * Encoding is not supported.
 * The canonical name is: X-UTF-8_with_ISO-8859-1_fallback
 */
